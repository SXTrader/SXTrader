...
namespace net.sxtrader.bftradingstrategies.sxhelper
{
    ...
    public partial class FormWelcome : FloatingWindow
    {
        ...
        {
            Image logo = Resource.image_logo;
        ...
        protected override void PerformPaint(PaintEventArgs e)
        {
            if (base.Handle != IntPtr.Zero)
            {
                ...
                g.DrawImageUnscaledAndClipped(
                    Resource.image_load_progress_texture,
                    new Rectangle(10, 36, (int)(w * mCompletionFraction), Resource.image_load_progress_texture.Height));
            }
        }
        #endregion
    }

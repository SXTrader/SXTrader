...
using System.Linq;
using System.Text;
using com.markus_heid.bftradingstrategies.betfairif;
using System.Globalization;

namespace com.markus_heid.bftradingstrategies.LayThe4
{
        ...
        public CompleteMarketPrices(int marketId)
        {
            ...
            if(rawMarketData != null)
            {
                ...
                for (int i = 1; i < stage1.Length; i++)
                {
                    ...
                    // Selektion speichern 
                    System.Diagnostics.Debug.WriteLine(String.Format("Selection {0}", stage3[SELECTIONIDINDEX]));
    ...
    class Selektion
    {
        ...
        public void addSelectionOdds(string rawData)
        {
            ...
            {
                if (odds[i] == String.Empty)
                    break;
                System.Diagnostics.Debug.WriteLine(String.Format("Quote {0}", odds[i]));

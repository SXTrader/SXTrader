...
{
    class OverUnderTradeLoader : TradeLoader
    {
        public override net.sxtrader.bftradingstrategies.tradeinterfaces.ITrade loadTrade(SXALBet bet, TTRWatcher watcher, out LOADTRADEMODE loadMode, out LIVESCOREADDED livescoreMode)
        {
